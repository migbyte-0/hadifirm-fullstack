...
import CaseStudyImageOne from "@/assets/images/thumb/case-study-1.webp";
import CaseStudyImageTwo from "@/assets/images/thumb/case-study-2.webp";
import CaseStudyImageThree from "@/assets/images/thumb/case-study-3.webp";
...
export default function CaseStudyThree() {
  ...
  return (
    <section className="case-study-area-3 pb-150 position-relative">
