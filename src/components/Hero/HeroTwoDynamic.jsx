import { useHeroContent } from "@/context/HomeContentContext";
...
export default function HeroTwoDynamic() {
  const {
    subtitle,
    titleLine1,
    titleHighlight,
  ...
  return (
    <section className="hero hero-two pb-120 position-relative">
              ...
              >
                <div className="circle_textwrap">
                  ...
                  <div className="about-circle-logo">
                    <img src={logoImage || LogoTwoSmall} alt="company-logo" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="hero-two-textwrap fade-slide top" data-delay="0.8">
        ...
        <p className="hero-text-left">{marqueeText}</p>
        <img src={CloseCircleImage} alt="Icon" />
      </div>
      ...
      {/* Shape  */}
      <img className="hero-two-shape" src={shapeImage || HeroTwoShape} alt="Shape" />
    </section>
  );
}
